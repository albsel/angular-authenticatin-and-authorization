...
export function fakeBackendFactory(
  ...
  let token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkFsYmFuIFNlbGltaSIsImFkbWluIjp0cnVlfQ.XF-fPS0VQOWUMOagSanq0CdeXVzEzmBhMYZOXvuH6ys";
  ...
  backend.connections.subscribe((connection: MockConnection) => {
    ...
    setTimeout(() => {
      ...
      if (
        ...
        if (body.email === "alban@domain.com" && body.password === "1234") {
